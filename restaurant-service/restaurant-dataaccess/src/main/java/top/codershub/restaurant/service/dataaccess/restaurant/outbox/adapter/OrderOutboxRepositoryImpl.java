package top.codershub.restaurant.service.dataaccess.restaurant.outbox.adapter;

import top.codershub.outbox.OutboxStatus;
import top.codershub.restaurant.service.dataaccess.restaurant.outbox.exception.OrderOutboxNotFoundException;
import top.codershub.restaurant.service.dataaccess.restaurant.outbox.mapper.OrderOutboxDataAccessMapper;
import top.codershub.restaurant.service.dataaccess.restaurant.outbox.repository.OrderOutboxJpaRepository;
import top.codershub.restaurant.service.domain.outbox.model.OrderOutboxMessage;
import top.codershub.restaurant.service.domain.ports.output.repository.OrderOutboxRepository;
