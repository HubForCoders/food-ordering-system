package top.codershub.payment.service.dataaccess.outbox.adapter;

import top.codershub.domain.valueobject.PaymentStatus;
import top.codershub.outbox.OutboxStatus;
import top.codershub.payment.service.dataaccess.outbox.exception.OrderOutboxNotFoundException;
import top.codershub.payment.service.dataaccess.outbox.mapper.OrderOutboxDataAccessMapper;
import top.codershub.payment.service.dataaccess.outbox.repository.OrderOutboxJpaRepository;
import top.codershub.payment.service.domain.outbox.model.OrderOutboxMessage;
import top.codershub.payment.service.domain.ports.output.repository.OrderOutboxRepository;
