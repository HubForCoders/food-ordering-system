package top.codershub.order.service.dataaccess.outbox.restaurantapproval.adapter;

import top.codershub.order.service.dataaccess.outbox.restaurantapproval.exception.ApprovalOutboxNotFoundException;
import top.codershub.order.service.dataaccess.outbox.restaurantapproval.mapper.ApprovalOutboxDataAccessMapper;
import top.codershub.order.service.dataaccess.outbox.restaurantapproval.repository.ApprovalOutboxJpaRepository;
import top.codershub.order.service.domain.outbox.model.approval.OrderApprovalOutboxMessage;
import top.codershub.order.service.domain.ports.output.repository.ApprovalOutboxRepository;
