...
public class RestaurantApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private top.codershub.kafka.order.avro.model.OrderApprovalStatus orderApprovalStatus;
   ...
   */
  public RestaurantApprovalResponseAvroModel(String id, String sagaId, String restaurantId, String orderId, java.time.Instant createdAt, top.codershub.kafka.order.avro.model.OrderApprovalStatus orderApprovalStatus, java.util.List<String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, Object value$) {
    ...
    case 5: orderApprovalStatus = (top.codershub.kafka.order.avro.model.OrderApprovalStatus)value$; break;
   ...
   */
  public top.codershub.kafka.order.avro.model.OrderApprovalStatus getOrderApprovalStatus() {
   ...
   * @param value the value to set.
   */
  public void setOrderApprovalStatus(top.codershub.kafka.order.avro.model.OrderApprovalStatus value) {
   ...
   */
  public static top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder newBuilder() {
    return new top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder();
  }
   ...
   * @return A new RestaurantApprovalResponseAvroModel RecordBuilder
   */
  public static top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder newBuilder(top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder other) {
    if (other == null) {
      return new top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder();
    } else {
      return new top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new RestaurantApprovalResponseAvroModel RecordBuilder
   */
  public static top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder newBuilder(top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel other) {
    if (other == null) {
      return new top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder();
    } else {
      return new top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setSagaId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setRestaurantId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearRestaurantId() {
      restaurantId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setOrderId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setOrderApprovalStatus(top.codershub.kafka.order.avro.model.OrderApprovalStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearOrderApprovalStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setFailureMessages(java.util.List<String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearFailureMessages() {
    ...
    public RestaurantApprovalResponseAvroModel build() {
      try {
        ...
        record.orderApprovalStatus = fieldSetFlags()[5] ? this.orderApprovalStatus : (top.codershub.kafka.order.avro.model.OrderApprovalStatus) defaultValue(fields()[5]);
