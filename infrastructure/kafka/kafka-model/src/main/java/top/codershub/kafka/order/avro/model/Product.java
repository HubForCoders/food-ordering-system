...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"top.codershub.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"logicalType\":\"uuid\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static top.codershub.kafka.order.avro.model.Product.Builder newBuilder() {
    return new top.codershub.kafka.order.avro.model.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static top.codershub.kafka.order.avro.model.Product.Builder newBuilder(top.codershub.kafka.order.avro.model.Product.Builder other) {
    if (other == null) {
      return new top.codershub.kafka.order.avro.model.Product.Builder();
    } else {
      return new top.codershub.kafka.order.avro.model.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static top.codershub.kafka.order.avro.model.Product.Builder newBuilder(top.codershub.kafka.order.avro.model.Product other) {
    if (other == null) {
      return new top.codershub.kafka.order.avro.model.Product.Builder();
    } else {
      return new top.codershub.kafka.order.avro.model.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(top.codershub.kafka.order.avro.model.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(top.codershub.kafka.order.avro.model.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.Product.Builder setId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.Product.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.Product.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public top.codershub.kafka.order.avro.model.Product.Builder clearQuantity() {
